...
"""
"""
# Test Case 1: I will try to open my last week assignment file which is in my cureent working directory. If I give wrong file name
try:
...
try:
    ...
    print(' KeyboardInterrupt :- The program is aborted by end user using ctrl + c')
